...
import { MdOutlineFoodBank, MdOutlineLogout,  MdOutlinePersonOutline, MdOutlineSettingsSuggest , MdNotificationsNone     } from 'react-icons/md';
const SideBar = (props) => {
        ...
        py-3 rounded-tr-xl rounded-br-xl z-50 ${showMenu ? "left-0" : "-left-full"} transition-all`}>
            <div>
                <ul className="mt-5 pl-4 ">
                    ...
                    <li className=" bg-[#1e1e24]  p-4 rounded-tl-xl rounded-bl-xl">
                        <a href="#" className="text-white bg-[#dd7d36] flex justify-center rounded-xl  p-4 text-center">
                            <MdOutlineFoodBank className="text-3xl  "/>
                        </a>
                    </li>
                    <li className=" hover:bg-[#1e1e24] p-4 rounded-tl-xl rounded-bl-xl group transition-colors">
